...
library(readr)
sbux.df <- read_csv("C:/Users/Jorge/Documents/GitHub/curso-series-temporales/2. Serie temporal en R y Python/R/sbuxPrices.csv")
View(sbux.df)
...
msft.df <- read_csv('C:/Users/Jorge/Documents/GitHub/curso-series-temporales/2. Serie temporal en R y Python/R/msftPrices.csv')
View(sbux.df)
...
plot(window(sbux.ts, start=c(2000,3), end=c(2008,3)), ylab="Adjusted close",col="blue", lwd=2, main="Monthly closing price of SBUX") 

#Plot para m???ltiples columnas
#En gr???ficos diferentes
plot(sbuxmsft.ts) 

#En el mismo gr???fico
plot(sbuxmsft.ts, plot.type="single", main="Monthly closing prices on SBUX and MSFT", ylab="Adjusted close price", 
...
sbux.z2 = read.zoo("C:/Users/Jorge/Documents/GitHub/curso-series-temporales/2. Serie temporal en R y Python/R/sbuxPrices.csv",
